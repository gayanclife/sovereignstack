...
// DB returns the underlying *sql.DB. Used by the Pruner (Phase G2) to
// run retention DELETEs against the same database the logger writes to.
func (l *SQLiteLogger) DB() *sql.DB { return l.db }
